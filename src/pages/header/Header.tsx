...
function Header() {
    ...
    const toogleDropdown = (element: string) => {
        const myDropdown = new Dropdown(document.getElementById(element) || element);
        myDropdown.toggle();
    }

    return (
        <header className='position-sticky top-0 start-0 end-0 bg-primary p-3 z-2'>
            <div className='header-wrapper m-auto d-flex'>
                ...
                <div className='ms-3 align-items-center d-flex cursor-pointer'>
                ...
                <div className='ms-3 align-items-center d-flex cursor-pointer dropdown'>
                {/* onClick={() => toogleDropdown('themeToogle')} */}
                    <div id='themeToogle' data-bs-toogle="dropdown" className='dropdown-toggle' aria-expanded="false">
